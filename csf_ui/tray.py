...
# Cargar submódulos sin pasar por csf_ui/__init__.py (que importa
# queue_window.py con Gtk 4).
...
import csf_client  # noqa: E402

# Cargar settings_menu como módulo suelto (no parte de csf_ui)
_settings_menu_path = _HERE / "settings_menu.py"
_spec = _ilu.spec_from_file_location("csf_ui_settings_menu", _settings_menu_path)
settings_menu = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(settings_menu)
...
class TrayApp:
    ...
    def __init__(self, socket_path: str | None = None):
        ...
        self._client: csf_client.DaemonClient | None = None
    ...
    def run(self):
        ...
        try:
            self._client = csf_client.DaemonClient(socket_path=self._socket_path)
        except csf_client.DaemonConnectionError as e:
    ...
    def _on_tick(self) -> bool:
        ...
        except csf_client.DaemonConnectionError:
            return True
    ...
    def _build_window(self):
        ...
        self._list_store = Gtk.ListStore(str, str, float, str)
